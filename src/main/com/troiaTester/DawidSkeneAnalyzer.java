...
public class DawidSkeneAnalyzer {
	 ...
	 */
	public DawidSkeneAnalyzer(TroiaRequest request, TestData data,
			int iterations) {
		super();
	 ...
	 * @return the request
	 */
	public TroiaRequest getRequest() {
		return request;
	}
	 ...
	 */
	public void setRequest(TroiaRequest request) {
		this.request = request;
	}
	...
	/**
	 * Labels for testing if no test data is used
	 */
